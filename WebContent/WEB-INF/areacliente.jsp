							...
							<div class="table-responsive">
								<table class="table align-items-center table-flush table-hover"
									...
									<thead class="thead-light">
										<tr>
											<th style="font-size: 18px; color: black">ID dell'ordine</th>
											<th style="font-size: 18px; color: black">Data Acquisto</th>
											<th style="font-size: 18px; color: black">Dettagli</th>
										</tr>
									</thead>
									<tbody>
			...
			<div class="col-lg-8">
				...
				<div class="card mb-4">
					<div
						class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
						<form action="Home1">
							<button style="background-color:black; border-color:black; color:white"; type="submit">Effettua un ordine</button>
						</form>
					</div>
					<div class="card-body">
					<h6 style="font-size: 25px; color: black"; class="m-0 font-weight-bold text-primary">Contatta l'assistenza</h6>
