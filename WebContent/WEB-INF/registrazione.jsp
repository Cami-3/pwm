									...
									<table>
										...
										<tr>
											...
											<td><s:textfield cssClass="form-control"
													name="cliente.nome" /></td>
										</tr>
										<tr>
											<td><label for="cognome">Cognome </label></td>
											<td><s:textfield cssClass="form-control"
													name="cliente.cognome" /></td>
										</tr>
										<tr>
											<td>
												<form>
											...
											<td><input type="date" name="cliente.datanascita"></td>
											</form>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><s:textfield cssClass="form-control"
													name="cliente.PIva" /></td>
										</tr>
										<tr>
											<td><label for="iban">Iban </label></td>
											<td><s:textfield cssClass="form-control"
													name="cliente.iban" /></td>
										</tr>
										<tr>
											<td><label for="telefono">Numero di telefono</label></td>
											<td><s:textfield cssClass="form-control"
													name="account.numero" /></td>
										</tr>
										<tr>
